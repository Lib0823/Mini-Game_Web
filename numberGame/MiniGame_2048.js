...
function coloring(cell){
    ...
    switch(cellNum){
        case 0:
        case 2:
            cell.style.color="#003052";
            cell.style.background="#e8fbd9";
            break;
        case 4:
            cell.style.color="#003052";
            cell.style.background="#d8f8be";
            break;
        case 8:
            cell.style.color="#003052";
            cell.style.background="#c5f59e";w
            break;
        case 16:
            cell.style.color="#003052";
            cell.style.background="#b2f27e";
            break;
        case 32:
            cell.style.color="#003052";
            cell.style.background="#a1ef61";
            break;
        case 64:
            cell.style.color="#003052";
            cell.style.background="#91ec46";
            break;
        case 128:
            cell.style.color="#003052";
            cell.style.background="#7be821";
            break;
        case 256:
            cell.style.color="#003052";
            cell.style.background="#6cd516";
            break;
        case 512:
            cell.style.color="#003052";
            cell.style.background="#46ecaa";
            break;
        case 1024:
            cell.style.color="#003052";
            cell.style.background="#17e392";
            break;
        case 2048:
            cell.style.color="#003052";
            cell.style.background="#13be7a";
            break;
        default:
            if(cellNum>2048){
                cell.style.color="#003052";
                cell.style.background="#11a76b";
            }
            else{
                cell.style.color="#003052";
                cell.style.background="#e8fbd9";
